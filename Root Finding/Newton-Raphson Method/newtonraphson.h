...
/**
 * Applies the Newton-Raphson method of root finding to find a zero of the provided
 * function f.
 *
 * NOTE: This function requires both the f and the f_prime (i.e. the first derivative)
 * to be defined in order to work. In case the function is updated, the user should also
 * update the derivative function.
 *
